...
{
    public interface IPoolManager: ICoreGameObject
    {
        ICoreObjectInstantiate GetPoolable(ICoreObjectInstantiate obj);
        void ReturnPoolable(ICoreObjectInstantiate obj);
    }
    ...
    /// </summary>
    public class PoolManager : Singleton<IPoolManager>, IPoolManager
    {
        /// <summary>
        ...
        GameObject ICoreGameObject.GameObject => this.gameObject;

        ICoreObjectInstantiate IPoolManager.GetPoolable(ICoreObjectInstantiate obj)
        {
            return obj;
        }

        void IPoolManager.ReturnPoolable(ICoreObjectInstantiate obj)
        {
        }
